...
JAVA_ARGS="-Dlogback.configurationFile=logback.xml -Dgnu.io.rxtx.SerialPorts=/dev/ttyACM0:/dev/ttyACM1:/dev/ttyACM2:/dev/ttyACM3:/dev/ttyACM4:/dev/ttyACM5:/dev/ttyACM6:/dev/ttyACM7:/dev/ttyACM8:/dev/ttyACM9:/dev/ttyS0:/dev/ttyS1:/dev/ttyUSB0 -Xms4g -Xmx32g -XX:MaxGCPauseMillis=1000 -XX:NewRatio=1"
